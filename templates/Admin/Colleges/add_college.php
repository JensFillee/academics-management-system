                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="short_name" id="short_name" placeholder="Enter short name" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" min="10" name="total_faculty" id="total_faculty" placeholder="Enter number of faculties">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
