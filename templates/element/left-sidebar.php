<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= $this->Url->build('/admin', ['fullBase' => true]) ?>" class="brand-link">
        ...
        ?>
        <!-- THIS WORKS FINE: <img src="/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> -->
        <span class="brand-text font-weight-light" style="font-size: 18px;">Academics Management</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="/dist/img/user8-128x128.jpg" class="img-circle elevation-2" style="width:55px; height:55px;" alt="User Image">
            </div>
            <div class="info">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= $this->Url->build('/admin', ["fullbase" => true]) ?>" class="nav-link">
                        <!-- returns “http://academics_management_system.test/admin” -->
